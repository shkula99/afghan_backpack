...
class HeratRestaurantsScreen extends StatefulWidget {


  @override
  State<HeratRestaurantsScreen> createState() => _HeratRestaurantsScreenState();
}

class _HeratRestaurantsScreenState extends State<HeratRestaurantsScreen> {
  ...
  Future<List<Restaurant>> _fetchRestaurants() async {
    ...
    // Only select restaurants from Herat
    final balkhRestaurants = allRestaurants.where((restaurant) => restaurant.provinceId == 2).toList();
