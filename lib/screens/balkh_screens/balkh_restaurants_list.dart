...
import 'balkh_restaurant_details.dart'; // adjust this import path as needed
...
class _BalkhRestaurantsScreenState extends State<BalkhRestaurantsScreen> {
  ...
  Future<List<Restaurant>> _fetchRestaurants() async {
    ...
    final result = await db.query('restaurants', where: 'province = ?', whereArgs: ['Balkh']);
    print(result);
      ...
      body: SafeArea(
        child: FutureBuilder<List<Restaurant>>(
          ...
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || snapshot.data!.isEmpty) return Center(child: Text("No restaurants found"));

            final restaurants = snapshot.data!;

            return Column(
              children: [
                // Your header & title remain unchanged
                Padding(
                        ...
                        return RestaurantCard(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    BalkhRestaurantDetailScreen(restaurantId: restaurant.id),
                              ),
                            );
                          },
                        );
