...
class BamiyanHistoricalPlacesScreen extends StatefulWidget {


  @override
  State<BamiyanHistoricalPlacesScreen> createState() => _BamiyanHistoricalPlacesScreenState();
}

class _BamiyanHistoricalPlacesScreenState extends State<BamiyanHistoricalPlacesScreen> {
  ...
  Future<List<HistoricalPlace>> _fetchHistoricalPlaces() async {
    ...
    // Only select historical places from Bamiyan
    final bamiyanHistoricalPlaces = allHistoricalPlaces.where((historicalPlace) => historicalPlace.provinceId == 4).toList();

    return bamiyanHistoricalPlaces;
  }
