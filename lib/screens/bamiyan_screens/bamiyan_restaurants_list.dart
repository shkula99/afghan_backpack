...
class BamiyanRestaurantsScreen extends StatefulWidget {


  @override
  State<BamiyanRestaurantsScreen> createState() => _BamiyanRestaurantsScreenState();
}

class _BamiyanRestaurantsScreenState extends State<BamiyanRestaurantsScreen> {
  ...
  Future<List<Restaurant>> _fetchRestaurants() async {
    ...
    // Only select restaurants from Bamiyan
    final bamiyanRestaurants = allRestaurants.where((restaurant) => restaurant.provinceId == 4).toList();

    return bamiyanRestaurants;
  }
