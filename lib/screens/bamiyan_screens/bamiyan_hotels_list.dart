...
class BamiyanHotelsScreen extends StatefulWidget {


  @override
  State<BamiyanHotelsScreen> createState() => _BamiyanHotelsScreenState();
}

class _BamiyanHotelsScreenState extends State<BamiyanHotelsScreen> {
  ...
  Future<List<Hotel>> _fetchHotels() async {
    ...
    // Only select hotels from Bamiyan
    final bamiyanHotels = allHotels.where((hotel) => hotel.provinceId == 4).toList();
    return bamiyanHotels;
  }
