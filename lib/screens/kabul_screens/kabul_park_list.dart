...
class KabulParksScreen extends StatefulWidget {


  @override
  State<KabulParksScreen> createState() => _KabulParksScreenState();
}

class _KabulParksScreenState extends State<KabulParksScreen> {
  ...
  Future<List<Park>> _fetchParks() async {
    ...
    // Only select parks from Kabul
    final kabulParks = allParks.where((park) => park.provinceId == 1).toList();
