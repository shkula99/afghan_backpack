...
class KabulHistoricalPlacesScreen extends StatefulWidget {


  @override
  State<KabulHistoricalPlacesScreen> createState() => _KabulHistoricalPlacesScreenState();
}

class _KabulHistoricalPlacesScreenState extends State<KabulHistoricalPlacesScreen> {
  ...
  Future<List<HistoricalPlace>> _fetchHistoricalPlaces() async {
    ...
    // Only select historical places from kabul
    final balkhHistoricalPlaces = allHistoricalPlaces.where((historicalPlace) => historicalPlace.provinceId == 1).toList();
