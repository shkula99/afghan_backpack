...
class KabulRestaurantsScreen extends StatefulWidget {


  @override
  State<KabulRestaurantsScreen> createState() => _BalkhRestaurantsScreenState();
}

class _BalkhRestaurantsScreenState extends State<KabulRestaurantsScreen> {
  ...
  Future<List<Restaurant>> _fetchRestaurants() async {
    ...
    // Only select restaurants from Kabul
    final balkhRestaurants = allRestaurants.where((restaurant) => restaurant.provinceId == 1).toList();
